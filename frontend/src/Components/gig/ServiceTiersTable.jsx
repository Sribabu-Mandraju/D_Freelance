          ...
          <table className="w-full">
            ...
            <tbody>
              ...
              <tr className="border-b border-cyan-500/20 hover:bg-cyan-500/10 transition-colors">
                ...
                <td className="text-center py-4 px-6 text-gray-300">{basic.code_reviews}</td>
                <td className="text-center py-4 px-6 text-gray-300">{standard.code_reviews}</td>
                <td className="text-center py-4 px-6 text-gray-300">{pro.code_reviews}</td>
              </tr>
              <tr className="border-b border-cyan-500/20 hover:bg-cyan-500/10 transition-colors">
              ...
              <tr className="border-b border-cyan-500/20 bg-gradient-to-r from-cyan-500/5 to-blue-500/5 hover:bg-cyan-500/10 transition-colors">
                ...
                <td className="text-center py-4 px-6 text-gray-300">
                  {basic.custom_ui ? <Check className="w-6 h-6 text-green-400 mx-auto" /> : ""}
                </td>
                <td className="text-center py-4 px-6">
                  {standard.custom_ui ? <Check className="w-6 h-6 text-green-400 mx-auto" /> : ""}
                </td>
                <td className="text-center py-4 px-6">
                  {pro.custom_ui ? <Check className="w-6 h-6 text-green-400 mx-auto" /> : ""}
                </td>
              </tr>
              <tr className="border-b border-cyan-500/20 hover:bg-cyan-500/10 transition-colors">
