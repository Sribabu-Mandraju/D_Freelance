      ...
      <div className="flex items-start space-x-6 mb-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-300 leading-relaxed">
            hi buddies ! i am passionate fullstack MERN developer and I am here to erase the boundary of limits for
            improving my skills and collaborate with professionals in my interested field and share my knowledge and I
            am passionate in building in best user friendly designs and responsive designs to...{" "}
