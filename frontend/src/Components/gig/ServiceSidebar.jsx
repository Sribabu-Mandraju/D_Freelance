      ...
      <div className="sticky top-6 space-y-6">
        ...
        <div className="bg-black/40 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-6 shadow-2xl shadow-cyan-500/10">
          ...
          <div className="space-y-4">
           ...
           <button className="w-full border-2 border-cyan-500/50 text-white py-4 px-6 rounded-lg font-semibold hover:bg-cyan-500/10 hover:border-cyan-400 transition-all duration-300 flex justify-center items-center">
              <Link
              to="#"
              onClick={() =>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Fund the project upfront. Sribabu gets paid once you are
