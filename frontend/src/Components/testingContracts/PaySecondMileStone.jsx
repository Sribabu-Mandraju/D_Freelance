...
function PaySecondMilestoneButton({ proposalId }) {
  ...
  useEffect(() => {
    updateTxToast(hasShownToast, {
      ...
      hash,
      messages: {
        pending: "Processing second milestone payment...",
        confirming: "Confirming second milestone payment...",
        success: "Second milestone payment successful!",
      },
    });
    return () => {};
...
export default PaySecondMilestoneButton;
