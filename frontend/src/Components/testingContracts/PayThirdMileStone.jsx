...
function PayThirdMilestone() {
  ...
  useEffect(() => {
    ...
    if (isPending && !hasShownToast.current) {
      toastId = toast.loading("Processing third milestone payment...");
      hasShownToast.current = true;
    } else if (isConfirming && !hasShownToast.current) {
      toastId = toast.loading("Confirming third milestone payment...");
      hasShownToast.current = true;
    } else if (isConfirmed && !hasShownToast.current) {
      toastId = toast.success("Third milestone payment successful!");
      hasShownToast.current = true;
  ...
  return (
    <div className="p-5 max-w-md mx-auto bg-gray-800 rounded-lg shadow-lg">
      <h3 className="text-xl font-semibold mb-4 text-gray-100">Pay Third Milestone</h3>
      <div className="mb-4">
...
export default PayThirdMilestone;