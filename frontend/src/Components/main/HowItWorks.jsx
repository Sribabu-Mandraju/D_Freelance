...
const steps = [
  {
    ...
    description: "Sign in securely using your crypto wallet to establish a decentralized, password-free identity."
  },
  {
    number: 2,
    title: "Post or Browse Jobs",
    description: "Clients can post jobs directly to the blockchain. Freelancers explore and bid on jobs across various categories."
  },
  {
    number: 3,
    title: "Smart Contract Agreement",
    description: "Both parties agree on job terms. A smart contract locks the funds in escrow, ensuring transparency and trust."
  },
  {
    number: 4,
    title: "Deliver Work & Approve",
    description: "Freelancer completes and submits the work. The client reviews and approves it through the platform."
  },
  {
    number: 5,
  ...
  },
  {
    ...
    description: "Both users gain on-chain reputation. If issues arise, decentralized arbitration ensures fair dispute resolution."
  }
]
...
function StepCard({ step, index }) {
  ...
  return (
   <div
    ...
    >
      <div className="relative bg-gray-900/70 backdrop-blur-md border border-gray-800 rounded-2xl p-8 h-full 
                     hover:border-purple-500/60 hover:shadow-xl hover:shadow-purple-500/10 
                     transition-all duration-300 ease-in-out">
        {/* Number Badge */}
        <div className="absolute -top-5 left-4 bg-gradient-to-br from-purple-600 to-cyan-500 
                       rounded-full w-14 h-14 flex items-center justify-center text-xl font-extrabold 
        ...
        <div className="pt-8 pl-2">
          <h3 className="text-2xl font-bold mb-3 bg-gradient-to-r from-purple-400 to-cyan-300 
        ...
        {/* Decorative Element */}
        <div className="absolute bottom-0 right-0 w-24 h-24 bg-gradient-to-tl from-purple-500/20 to-cyan-500/20 
