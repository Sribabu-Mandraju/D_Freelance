...
//     <>
//       <Navbar />
//       <div className={`${styles.container} bg-gradient-to-br from-gray-900 via-black to-gray-900 relative overflow-hidden`}>
...
//                     setFeaturedProjects={setPortfolioData}
//                   />
//                 </div>
//               )}
...
//               setCurrentStatus={setPortfolioData}
//             />
//             <TechHighlights
//               techHighlights={techHighlights}
//               setTechHighlights={setPortfolioData}
//             />
//           </aside>
//         </div>
//       </div>
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row flex-1 overflow-hidden pt-20 sm:px-4 lg:px-20 relative z-10">
          <main
            ...
            style={{ maxHeight: "calc(100vh - 80px)" }}
          >
            <HeroSection personalInfo={personalInfo} setPersonalInfo={setPortfolioData} />
