...
import FeaturedProjects from "./FeaturesProjects"; // Fixed typo: FeaturesProjects → FeaturedProjects
        ...
        <div className="flex flex-col lg:flex-row flex-1 overflow-hidden pt-20 sm:px-4 lg:px-20 relative z-10">
          ...
          >
            ...
            <div className="space-y-8">
              ...
              {activeTab === "Gigs" && (
                <div className="text-gray-300">No gigs available</div>
                // <YourGigs yourgigs={userGigs} /> // Commented out, can be restored if needed
              )}
